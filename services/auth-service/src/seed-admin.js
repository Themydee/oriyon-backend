...
async function seedAdmin() {
    ...
    await authDb.execute(sql `INSERT INTO auth_users (id, email, password_hash, role, is_active)
    ...
    await userDb.execute(sql `INSERT INTO users (id, email, first_name, last_name, role, is_active)
